...
export default function LandingPage() {
  return (
    <div className="font-sans text-brown-800 bg-white overflow-hidden">
      ...
      <div className="">
        <section className="relative bg-lime-200 min-h-screen flex flex-col items-center text-center px-4 py-10 shadow-inner mb-20">
          <img
            src={coelho2}
            className="absolute size-32 md:size-48 bottom-0 left-0 transform scale-x-[-1] Z-50"
            alt=""
          />
          <div className="flex relative">
            <h1 className="text-[5vh] font-bold mb-12">
              <span className="relative text-lime-600 text-[5vh] font-extrabold mr-6">
                <img
                  src={parabens}
                  alt="simbolo de comemoracao"
                  className="absolute -left-14 -top-4 size-[5vh]"
                ></img>
                <img
                  src={confete}
                  alt="simbolo de comemoracao"
                  className="absolute left-[100%] -top-4 size-[5vh]"
                ></img>
                Parabens
              </span>{" "}
              por ter completado o Quiz!<br></br>
              <span className="text-neutral-700">
                Com base nas suas respostas, achamos uma oferta:
              </span>
            </h1>
          </div>
          <h1 className="text-[5vh] md:text-[7vh] font-bold mb-4 text-brown-700">
            Transforme a Páscoa em Lucro <br></br>com Ovos Artesanais
          </h1>
          <p className="text-[3vh] w-3/4 md:w-1/2 font-semibold text-brown-600">
          ...
          <button
            ...
            className="bg-white border-black text-black px-6 py-3 rounded-2xl w-1/3 text-[2vh] hover:bg-lime-400 hover:scale-105 transition shadow-2xl shadow-neutral-800 font-bold my-5 md:my-20"
          >
            Quero meu eBook
          </button>
        ...
        <section className=" font-medium text-center px-4 flex flex-col items-center justify-start w-full gap-20 py-20 bg-white">
          <div className="relative">
            <h1 className="font-medium text-neutral-800 text-[5vh]">
              <span className="text-lime-500 font-bold">Precisa fazer</span> uma
              renda extra esse mes?
            </h1>
            <h2 className="flex flex-wrap justify-center items-center relative text-center font-light text-neutral-700 text-[4vh] mt-2 z-20">
              {" "}
              <div className="h-16 md:h-24 rounded-sm bg-pink-500 flex items-center justify-center mr-2 px-5">
                <p className="font-bold text-[4vh] text-white">Nao sabe</p>
              </div>
              por onde comecar?{" "}
              <span className="font-bold text-[5vh] text-lime-500 mx-2">
                QUAL
              </span>
              produto vender?
            </h2>
          </div>
          <div className="gap-10 flex flex-col items-center justify-around w-full">
            <div className="relative w-4/5 md:w-1/2 bg-lime-300 p-4 shadow-lg text-center flex items-center justify-center font-medium text-[3vh] rounded-2xl">
              <div className="absolute rotate-45 -top-10 left-[80%]">
                <img src={question} alt="" className="size-12" />
              </div>
              <img src={retangulo} alt="" className="size-12 mr-5" /> Se sente
            ...
            <div className="relative w-4/5 md:w-1/2 bg-lime-300 p-4 shadow-lg text-center flex items-center justify-center font-medium text-[3vh] rounded-2xl">
              ...
              <img src={retangulo} alt="" className="size-12 mr-5" /> O cansaco
            ...
            <div className="relative w-4/5 md:w-1/2 bg-lime-300 p-4 shadow-lg text-center flex items-center justify-center font-medium text-[3vh] rounded-2xl">
              ...
              <img src={retangulo} alt="" className="size-12 mr-5" /> Voce
              deseja fazer uma renda a mais pra fechar o mes
            </div>
            <div className="relative w-4/5 md:w-1/2 bg-lime-300 p-4 shadow-lg text-center flex items-center justify-center font-medium text-[3vh] rounded-2xl">
              <div className="absolute -rotate-45 -top-10 left-14">
                <img src={question} alt="" className="size-12" />
              </div>
              <img src={retangulo} alt="" className="size-12 mr-5" /> Aprender
              algo novo que gere renda
            </div>
          </div>
        </section>

        <section className="relative bg-orange-100 font-medium text-center flex flex-col items-center justify-around gap-10 py-20">
          <img
            src={coelho}
            className="size-32 md:size-48 absolute bottom-0 right-0 z-50"
            alt=""
          />
          <h1 className="font-bold text-[4vh] w-3/4 md:w-2/3">
          ...
          <div className="flex flex-col justify-around rounded-2xl gap-8 bg-white py-10 mx-10">
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Tecnicas Basicas de Vendas</p>
            </div>
            ...
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Praticas para o dia a dia</p>
            </div>
            <div class="relative h-1 w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-400 to-transparent animate-line-grow"></div>
            </div>{" "}
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Conceitos basicos de negocios</p>
            </div>
            <div class="relative h-1 w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-400 to-transparent animate-line-grow"></div>
            </div>{" "}
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Nocao introdutoria a marketing</p>
            </div>
          </div>
          <h2 className="font-bold text-[4vh] w-3/4 md:w-2/3">
            Vamos ensinar{" "}
          ...
          <div className="flex flex-col justify-around rounded-2xl gap-8 bg-white py-10 mx-10">
            <div className="flex mx-16 items-center gap-2 ">
              ...
              <p className="text-nowrap">
                Enfrentar o medo de falar em publico
              </p>
            </div>
            <div class="relative h-1 w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-400 to-transparent animate-line-grow"></div>
            ...
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Ultrapassar a vergonha da venda</p>
            </div>
            <div class="relative h-1 w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-400 to-transparent animate-line-grow"></div>
            </div>{" "}
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Carisma e Empatia</p>
            </div>
            <div class="relative h-1 w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-400 to-transparent animate-line-grow"></div>
            </div>{" "}
            <div className="mx-16 flex items-center gap-2 ">
              <img src={caixaMarcada} alt="" className="size-6" />
              <p className="text-nowrap">Conquistar seu publico</p>
            </div>
          </div>
        </section>
        {/* Sessão 2: Urgência */}
        <section className="bg-lime-200 text-black relative pt-32 pb-16 px-4 text-center flex flex-col items-center">
          <img
            src={trufas}
            alt="Trufas em linha"
            className="absolute left-1/2 lg:translate-x-[100%] translate-x-[120%] top-1/2 lg:top-3/4 -translate-y-1/2 w-[200px] lg:w-[450px] z-10"
          ></img>
          <img
            src={trufas2}
            alt="Trufas em linha"
          ...
          <img
            src={livroUm}
            alt="Capa do eBook"
            className="max-w-md rounded-xl mb-6 py-10"
          />
          <button
            onClick={() => (window.location.href = "/checkout")}
      ...
      <section className="bg-white text-black py-16 px-4 text-center flex flex-col items-center h-screen">
        <h2 className="text-[4vh] font-bold mb-2 text-brown-700">
          PRECOS PROMOCIONAIS
        </h2>
        ...
        <p className="font-semibold texl-md w-80">
          ...
          vencedores por 92% de desconto:
        </p>
        <h1 className="text-[4vh] font-bold mt-10">
          de <span className="text-red-500">R$67,90</span> por apenas
        </h1>
        <h1 className="text-[7vh] font-black text-green-900 mt-6">R$21,80</h1>
        <h2 className="mt-8 font-semibold">OU 2 x de R$10,90</h2>
        <button
          onClick={() => (window.location.href = "/checkout")}
      ...
      <section className="bg-lime-200 text-black py-16 px-4 text-center">
        <h2 className="text-[5vh] font-bold mb-4">
          Garanta agora seu eBook e comece a lucrar ainda hoje!
        </h2>
        <p className="text-[3vh] w-3/4 md:w-1/2 mx-auto mb-4">
        ...
        <button className="border-2 border-lime-400 hover:scale-105 shadow-lg shadow-neutral-500 h-12 w-72 mt-6 bg-white text-black rounded-lg text-[2vh] font-bold hover:bg-lime-400 hover:text-white transition">
          Garantir Ja
        </button>
        <div className="flex w-full items-center justify-center lg:gap-40">
          <div>
            <h3 className="font-black text-[4vh] mt-10">
